//iniciamos con las variables que utilizaremos un poco mas abajo
...
// con esto cambiamos el color al titulo que dise match game

$(document).ready(function() {
     setInterval(function(){
      $(".main-titulo").switchClass("main-titulo","main-titulo-efecto", 800),//nueva clase con otro color
      $(".main-titulo").switchClass("main-titulo-efecto","main-titulo", 800)
    }, 1000);
});

// aqui al darle click al boton de iniciar se inicia el juego
...
//  aqui comenzamos dezplazando las imagenees de dulces
...
// Temporizador para empezar el juego
...
// con esta funcion es para poner el los movimientos y puntos de toda la pantalla

function funcioncita(){
	$( ".panel-score" ).animate({width:'100%'},3000);//cambiamos el tamaño con la opcion animate
};

// con esta funcion lo que hace es borrar todo
...
function eliminarhorver(){
	...
	//hacemos un if para si no encuentra 3 dulces o más, llamamos a la función para volver a completar el juego
	...
	if(busquedaHorizontal==1||busquedaVertical==1){
		...
		$(".activo").hide("pulsate",1000,function(){
			...
			$(".activo").remove("img");//removemos la imagenes
			score=score+scoretmp*10;
			$("#score-text").html(score);//Agregamos la nueva score
		});
	}
	if(busquedaHorizontal==0 && busquedaVertical==0 && matriz==49){
		$(".elemento").draggable({
...
// con esta funcion es para intercambiar dulces
...
// con esta funcion es para crear nuevos dulces
...
// con esta funcion es para la busqueda horizontal de dulces
...
// con esta funcion para la busqueda vertical de dulces
